...
class AgentNN(nn.Module):
    ...
    def get_action_and_value(
        ...
        b_summary_embedding2 = b_summary_embedding + self.action1_upscaler(b_action1_logits)
        ...
        b_action2_logits = self.action2_net(b_summary_embedding2)
        ...
        b_summary_embedding3 = b_summary_embedding2 + self.action2_upscaler(b_action2_logits)
        ...
        b_action3_logits = self.action3_net(b_summary_embedding3)

...
if (os.getenv("VCMIGYM_DEBUG", None) == "1"):
    from ...connectors.build import exporter_v11
else:
    from ...connectors.rel import exporter_v11

EXPORTER = exporter_v11.Exporter()
...
class PyProcConnector():
    ...
    def _get_connector(self):
        if (os.getenv("VCMIGYM_DEBUG", None) == "1"):
            ...
            from ...connectors.build import connector_v11
        else:
            from ...connectors.rel import connector_v11

        return connector_v11

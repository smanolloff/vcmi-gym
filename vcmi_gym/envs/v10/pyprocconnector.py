...
if (os.getenv("VCMIGYM_DEBUG", None) == "1"):
    from ...connectors.build import exporter_v10
else:
    from ...connectors.rel import exporter_v10

EXPORTER = exporter_v10.Exporter()
...
class PyResult():
    def __init__(self, cres, shm_state):
...
class PyProcConnector():
    ...
    def start(self, *args):
        ...
        self.shm_intstates = multiprocessing.shared_memory.SharedMemory(create=True, size=MAXINTSTATES * STATE_SIZE * ctypes.sizeof(ctypes.c_float))
        ...
        return PyResult(self.v_result_act, self.shm_state)
    ...
    def _get_connector(self):
        if (os.getenv("VCMIGYM_DEBUG", None) == "1"):
            ...
            from ...connectors.build import connector_v10
        else:
            from ...connectors.rel import connector_v10

        return connector_v10
    ...
    def set_v_result_act(self, result):
        ...
        intstates = result.get_intermediate_states()

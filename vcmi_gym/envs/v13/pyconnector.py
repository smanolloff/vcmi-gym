...
if (os.getenv("VCMIGYM_DEBUG", None) == "1"):
    from ...connectors.build import exporter_v13
else:
    from ...connectors.rel import exporter_v13

EXPORTER = exporter_v13.Exporter()

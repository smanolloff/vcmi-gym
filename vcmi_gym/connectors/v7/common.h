...
namespace Connector::V7 {
    ...
    public:
        P_State(
            MMAI::Schema::V7::ISupplementaryData::Type type_,
            P_BattlefieldState state_,
            P_ActionMask actmask_,
            P_AttentionMask attnmask_,
            const MMAI::Schema::V7::ErrorCode errcode_,
            const MMAI::Schema::V7::Side side_,
        ...
        const MMAI::Schema::V7::ISupplementaryData::Type type;

...
namespace Connector::V11 {
    const int Exporter::getVersion() const { return 11; }
    ...
    const int Exporter::getSideLeft() const { return static_cast<int>(MMAI::Schema::V11::Side::LEFT); }
    const int Exporter::getSideRight() const { return static_cast<int>(MMAI::Schema::V11::Side::RIGHT); }
    ...
    PYBIND11_MODULE(exporter_v11, m) {

...
namespace Connector::V11::Proc {
    ...
    const MMAI::Schema::V11::ISupplementaryData* Connector::extractSupplementaryData(const MMAI::Schema::IState *s) {
        ...
        auto &t = typeid(const MMAI::Schema::V11::ISupplementaryData*);
        auto err = MMAI::Schema::AnyCastError(any, typeid(const MMAI::Schema::V11::ISupplementaryData*));

        if(!err.empty()) {
            LOGFMT("anycast for getSumpplementaryData error: %s", err);
        }

        return std::any_cast<const MMAI::Schema::V11::ISupplementaryData*>(s->getSupplementaryData());
    };
    ...
    const P_State Connector::convertState(const MMAI::Schema::IState* s) {
        ...
        assert(sup->getType() == MMAI::Schema::V11::ISupplementaryData::Type::REGULAR);
        ...
        constexpr ssize_t dstate = MMAI::Schema::V11::BATTLEFIELD_STATE_SIZE;
        constexpr ssize_t dmask = MMAI::Schema::V11::N_ACTIONS;
    ...
    const P_State Connector::reset() {
        ...
        assert(pstate.type == MMAI::Schema::V11::ISupplementaryData::Type::REGULAR);
        return pstate;
    }
    ...
    const std::string Connector::render() {
        ...
        assert(sup->getType() == MMAI::Schema::V11::ISupplementaryData::Type::ANSI_RENDER);

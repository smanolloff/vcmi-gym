...
namespace Connector::V8 {
    ...
    public:
        P_State(
            MMAI::Schema::V8::ISupplementaryData::Type type_,
            P_BattlefieldState state_,
            P_ActionMask actmask_,
            const MMAI::Schema::V8::ErrorCode errcode_,
        ...
        const MMAI::Schema::V8::ISupplementaryData::Type type;

...
namespace Connector::V8::Proc {
    ...
    const MMAI::Schema::V8::ISupplementaryData* Connector::extractSupplementaryData(const MMAI::Schema::IState *s) {
        ...
        auto &t = typeid(const MMAI::Schema::V8::ISupplementaryData*);
        auto err = MMAI::Schema::AnyCastError(any, typeid(const MMAI::Schema::V8::ISupplementaryData*));

        if(!err.empty()) {
            LOGFMT("anycast for getSumpplementaryData error: %s", err);
        }

        return std::any_cast<const MMAI::Schema::V8::ISupplementaryData*>(s->getSupplementaryData());
    };
    ...
    const P_State Connector::convertState(const MMAI::Schema::IState* s) {
        ...
        assert(sup->getType() == MMAI::Schema::V8::ISupplementaryData::Type::REGULAR);
    ...
    const P_State Connector::reset() {
        ...
        assert(pstate.type == MMAI::Schema::V8::ISupplementaryData::Type::REGULAR);
        return pstate;
    }
    ...
    const std::string Connector::render() {
        ...
        assert(sup->getType() == MMAI::Schema::V8::ISupplementaryData::Type::ANSI_RENDER);

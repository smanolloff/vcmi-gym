...
namespace Connector::V10::Proc {
    ...
    const MMAI::Schema::V10::ISupplementaryData* Connector::extractSupplementaryData(const MMAI::Schema::IState *s) {
        ...
        auto &t = typeid(const MMAI::Schema::V10::ISupplementaryData*);
        ...
        return std::any_cast<const MMAI::Schema::V10::ISupplementaryData*>(s->getSupplementaryData());
    };
    ...
    const P_State Connector::reset() {
        ...
        assert(pstate.type == MMAI::Schema::V10::ISupplementaryData::Type::REGULAR);
        return pstate;
    }
    ...
    const std::string Connector::render() {
        ...
        assert(sup->getType() == MMAI::Schema::V10::ISupplementaryData::Type::ANSI_RENDER);

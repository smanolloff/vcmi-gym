...
namespace Connector::V10 {
    const int Exporter::getVersion() const { return 10; }
    ...
    const int Exporter::getSideLeft() const { return static_cast<int>(MMAI::Schema::V10::Side::LEFT); }
    const int Exporter::getSideRight() const { return static_cast<int>(MMAI::Schema::V10::Side::RIGHT); }
    ...
    PYBIND11_MODULE(exporter_v10, m) {

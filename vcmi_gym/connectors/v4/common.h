...
namespace Connector::V4 {
    ...
    public:
        P_State(
            MMAI::Schema::V4::ISupplementaryData::Type type_,
            P_BattlefieldState state_,
            P_ActionMask actmask_,
            P_AttentionMask attnmask_,
            const MMAI::Schema::V4::ErrorCode errcode_,
            const MMAI::Schema::V4::Side side_,
        ...
        const MMAI::Schema::V4::ISupplementaryData::Type type;

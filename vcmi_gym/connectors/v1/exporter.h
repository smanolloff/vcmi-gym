...
namespace Connector::V1 {
    ...
    public:
        ...
        virtual const std::vector<std::string> getDmgmods() const;
        virtual const std::vector<std::string> getShootdistances() const;
        virtual const std::vector<std::string> getMeleedistances() const;
        virtual const std::vector<std::string> getHexactions() const;
        virtual const std::vector<std::string> getHexstates() const;
        virtual const std::vector<AttributeMapping> getAttributeMapping() const;

    protected:
        const std::vector<AttributeMapping> _getAttributeMapping(const HexEncoding &) const;
    };
}

...
namespace Connector::V6 {
    ...
    public:
        P_State(
            MMAI::Schema::V6::ISupplementaryData::Type type_,
            P_BattlefieldState state_,
            P_ActionMask actmask_,
            P_AttentionMask attnmask_,
            const MMAI::Schema::V6::ErrorCode errcode_,
            const MMAI::Schema::V6::Side side_,
        ...
        const MMAI::Schema::V6::ISupplementaryData::Type type;

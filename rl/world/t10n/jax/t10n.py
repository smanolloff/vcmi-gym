...
class EncoderLayer(fnn.Module):
    ...
    def setup(self):
        ...
        self.linear1 = fnn.Dense(2048)  # 2048=dim_feedforward in torch
...
def load_for_test():
    ...
    def load_self_attn(torch_prefix, jax_prefix_keys):
    ...
    load_self_attn("transformer_hex.layers.0.self_attn", ["transformer_hex", "layers_0", "self_attn"])
    load_self_attn("transformer_hex.layers.1.self_attn", ["transformer_hex", "layers_1", "self_attn"])
    load_self_attn("transformer_hex.layers.2.self_attn", ["transformer_hex", "layers_2", "self_attn"])
    load_self_attn("transformer_hex.layers.3.self_attn", ["transformer_hex", "layers_3", "self_attn"])
    load_self_attn("transformer_hex.layers.4.self_attn", ["transformer_hex", "layers_4", "self_attn"])
    load_self_attn("transformer_hex.layers.5.self_attn", ["transformer_hex", "layers_5", "self_attn"])
